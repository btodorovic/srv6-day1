...
set interfaces ge-0/0/0 unit 0 family inet address 3.36.1.2/24
set interfaces ge-0/0/0 unit 0 family iso
set interfaces ge-0/0/0 unit 0 family mpls
set interfaces ge-0/0/1 unit 0 description ConnectedToP2
set interfaces ge-0/0/1 unit 0 family inet address 4.46.1.2/24
set interfaces ge-0/0/1 unit 0 family iso
set interfaces ge-0/0/1 unit 0 family mpls
set interfaces ge-0/0/2 unit 0 description ConnectedToP3
set interfaces ge-0/0/2 unit 0 family inet address 5.56.1.2/24
set interfaces ge-0/0/2 unit 0 family iso
set interfaces ge-0/0/2 unit 0 family mpls
set interfaces ge-0/0/3 unit 0 description ConnectedToPE3
set interfaces ge-0/0/3 unit 0 family inet address 6.67.1.1/24
set interfaces ge-0/0/3 unit 0 family iso
set interfaces ge-0/0/3 unit 0 family mpls
set interfaces ge-0/0/4 unit 0 description ConnectedToPE4
set interfaces ge-0/0/4 unit 0 family inet address 6.68.1.1/24
set interfaces ge-0/0/4 unit 0 family iso
set interfaces ge-0/0/4 unit 0 family mpls
set interfaces lo0 unit 0 family inet address 6.6.6.6/32
set interfaces lo0 unit 0 family iso address 47.0005.0019.2168.6000.00
